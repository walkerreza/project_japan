            ...
            <div className="min-h-screen bg-[#F8F9FB] font-sans">
                ...
                <header className="bg-white border-b border-gray-200 px-6 py-4 sticky top-0 z-40 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-sm font-black text-gray-900">Tambah Pelajaran Baru</h1>
                            <p className="text-[11px] text-gray-400 font-medium">Isi detail pelajaran dan konten materi</p>
                        </div>
                    </div>
                    <button
                ...
                <main className="max-w-3xl mx-auto p-6 space-y-5">
                    ...
                    <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                <label className="block text-sm font-bold text-gray-700 mb-1.5">Urutan <span className="text-red-500">*</span></label>
                                <input
                                    type="number"
                                    min="0"
                                    value={data.order}
