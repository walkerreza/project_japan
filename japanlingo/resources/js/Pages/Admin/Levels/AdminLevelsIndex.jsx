...
export default function AdminLevelsIndex({ levels = [] }) {
        ...
        <AuthenticatedLayout>
            ...
            {deleteConfirm && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
                    <div className="w-full max-w-md rounded-2xl bg-white shadow-2xl">
                        <div className="p-6">
                            <h3 className="text-lg font-black text-gray-900">Hapus Level</h3>
                            <p className="mt-2 text-sm font-medium text-gray-500">
                                Level <span className="font-bold text-gray-700">{deleteConfirm.level_name}</span> akan dihapus. Pastikan level ini tidak lagi dipakai oleh konten lain.
                            </p>
                        </div>
                        <div className="flex justify-end gap-3 border-t border-gray-100 p-6">
                            ...
                            <button
                                ...
                                className="rounded-xl bg-red-600 px-5 py-2.5 text-sm font-black text-white shadow-md shadow-red-500/20 transition-colors hover:bg-red-700"
                            >
                                Hapus
                            </button>
                        </div>
