            ...
            <div className="space-y-6 px-4 py-6 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 gap-6 xl:grid-cols-[1.15fr_0.85fr]">
                    ...
                    <div className="space-y-6">
                        ...
                        <Card>
                            <h2 className="text-lg font-black text-gray-900 dark:text-white">Access Key Premium</h2>
                            <p className="mt-1 text-xs font-medium text-gray-500 dark:text-gray-400">Kode akses manual untuk demo tanpa payment gateway.</p>
                            <div className="mt-4 space-y-3">
                                {accessKeys.length === 0 && (
                                ...
                                {accessKeys.map((item) => (
                                    <div key={item.id} className="rounded-2xl border border-gray-100 p-4 dark:border-gray-800">
                                        ...
                                        {item.status === 'active' && (
                                            <button
                                                type="button"
                                                onClick={() => router.delete(route('superadmin.payments.access-keys.revoke', item.id), { preserveScroll: true })}
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
                    <div className="w-full max-w-lg rounded-2xl bg-white shadow-2xl dark:bg-gray-900">
                        <div className="border-b border-gray-100 p-6 dark:border-gray-800">
                            <h3 className="text-lg font-black text-gray-900 dark:text-white">Buat Access Key Premium</h3>
