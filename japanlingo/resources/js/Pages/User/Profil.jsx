            ...
            return (
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="bg-white dark:bg-gray-900 p-6 rounded-3xl border border-gray-100 dark:border-gray-800 shadow-sm flex flex-col items-center justify-center transition-colors">
                            <h4 className="text-gray-400 dark:text-gray-500 font-bold uppercase tracking-widest text-xs mb-2">Total XP Terkumpul</h4>
                            <span className="text-4xl font-black text-amber-500">12,450</span>
                        </div>
                        <div className="bg-white dark:bg-gray-900 p-6 rounded-3xl border border-gray-100 dark:border-gray-800 shadow-sm flex flex-col items-center justify-center transition-colors">
                            <h4 className="text-gray-400 dark:text-gray-500 font-bold uppercase tracking-widest text-xs mb-2">Peringkat Liga</h4>
            ...
            return (
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} className="bg-white dark:bg-gray-900 p-6 md:p-8 rounded-3xl border border-gray-100 dark:border-gray-800 shadow-sm space-y-8">
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <input type="password" placeholder="Minimal 8 karakter" className="w-full bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl px-4 py-3 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-600 focus:ring-red-100 focus:border-red-300 transition-colors" />
                            </div>
                            <div>
                                <label className="block text-sm font-bold text-gray-500 dark:text-gray-400 mb-1">Ulangi Sandi Baru</label>
                                <input type="password" placeholder="Konfirmasi sandi" className="w-full bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl px-4 py-3 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-600 focus:ring-red-100 focus:border-red-300 transition-colors" />
                            </div>
                        </div>
                    ...
                    <div className="bg-red-50 dark:bg-red-900/10 p-6 rounded-2xl border border-red-100 dark:border-red-900/30 transition-colors">
                        <h3 className="text-lg font-bold text-red-900 dark:text-red-400 mb-2">Zona Berbahaya</h3>
                        <p className="text-sm text-red-700 dark:text-red-300 mb-4">Jika Anda menghapus akun ini, seluruh rekam jejak XP, Sertifikat, dan langganan akan hangus secara permanen. Tidak dapat dipulihkan.</p>
                        <button className="px-6 py-3 rounded-xl font-bold text-red-600 dark:text-red-400 border border-red-200 dark:border-red-800/50 bg-white dark:bg-transparent hover:bg-red-50 dark:hover:bg-red-900/30 hover:text-red-700 dark:hover:text-red-300 transition-colors shadow-sm">
                            Hapus Akun Saya
                        </button>
                    </div>
                </motion.div>
            ...
            return (
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} className="bg-white dark:bg-gray-900 p-6 md:p-8 rounded-3xl border border-gray-100 dark:border-gray-800 shadow-sm overflow-hidden transition-colors">
                    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between mb-6">
                        <h3 className="text-lg font-bold text-gray-900 dark:text-white">Riwayat Tagihan & Langganan</h3>
                    </div>
                        ...
                        <table className="w-full min-w-[720px] text-left border-collapse">
                            <thead>
                                <tr className="border-b-2 border-gray-100 dark:border-gray-800">
                                    <th className="py-4 px-4 text-xs font-bold text-gray-400 dark:text-gray-500 uppercase tracking-wider">Tanggal</th>
                                    <th className="py-4 px-4 text-xs font-bold text-gray-400 dark:text-gray-500 uppercase tracking-wider">ID Faktur</th>
                                    <th className="py-4 px-4 text-xs font-bold text-gray-400 dark:text-gray-500 uppercase tracking-wider">Tipe Paket</th>
                                    <th className="py-4 px-4 text-xs font-bold text-gray-400 dark:text-gray-500 uppercase tracking-wider">Nominal Tagihan</th>
                                    <th className="py-4 px-4 text-xs font-bold text-gray-400 dark:text-gray-500 uppercase tracking-wider">Status Pembayaran</th>
                                </tr>
                            </thead>
                            <tbody>
                                {MOCK_INVOICES.map((inv, idx) => (
                                    <tr key={idx} className="border-b border-gray-50 dark:border-gray-800 hover:bg-gray-50/50 dark:hover:bg-gray-800/50 transition-colors">
                                        <td className="py-5 px-4 text-sm font-medium text-gray-600 dark:text-gray-400">{inv.date}</td>
                                        <td className="py-5 px-4 text-sm font-bold text-blue-600 dark:text-blue-400 underline cursor-pointer">{inv.id}</td>
                                        <td className="py-5 px-4 text-sm font-bold text-gray-900 dark:text-white">{inv.plan}</td>
                                        <td className="py-5 px-4 text-sm font-bold text-gray-900 dark:text-white">{inv.price}</td>
                                        <td className="py-5 px-4">
                                            {inv.status === 'Success' ? (
                                                <span className="inline-flex items-center gap-1.5 px-3 py-1 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400 rounded-lg text-xs font-black uppercase tracking-widest">
                                                    Berhasil
                                                </span>
                                            ) : (
                                                <span className="inline-flex items-center gap-1.5 px-3 py-1 bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-400 rounded-lg text-xs font-black uppercase tracking-widest">
                                                    Ditolak
                                                </span>
                                            )}
                                        </td>
                ...
                <div className={`relative w-full h-64 md:h-80 bg-gradient-to-r ${theme.ctaBg}`}>
                    ...
                    <div className="absolute left-1/2 -translate-x-1/2 -bottom-16 md:bottom-auto md:top-full md:-translate-y-1/2 md:left-16 lg:left-24 flex items-end">
                        <div className="w-28 h-28 sm:w-32 sm:h-32 md:w-40 md:h-40 rounded-full bg-white dark:bg-gray-900 p-2 shadow-[0_10px_40px_-10px_rgba(0,0,0,0.2)] transition-colors">
                            <div className="w-full h-full rounded-full flex items-center justify-center text-4xl font-black text-white relative overflow-hidden group cursor-pointer bg-gradient-to-br from-indigo-500 to-purple-600">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-24 md:mt-12">
                    ...
                    <div className="md:ml-40 lg:ml-56 mb-10 flex flex-col md:flex-row md:items-center gap-4 py-4 md:py-0">
                        ...
                        <div className="md:ml-auto">
                            <div className="inline-flex items-center gap-2 px-4 py-2 bg-yellow-100 dark:bg-yellow-900/30 border border-yellow-200 dark:border-yellow-800/50 text-yellow-700 dark:text-yellow-400 font-bold rounded-xl text-sm shadow-sm hover:scale-105 transition-transform cursor-pointer">
                                👑 Sabuk Premium (Aktif)
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-2 mb-8 border-b border-gray-200 dark:border-gray-800 pb-2">
                        <button 
                            ...
                            className={`w-full sm:w-auto px-5 py-3 rounded-t-2xl font-black text-sm tracking-wide transition-all ${
                                activeTab === 'stats' ? 'bg-white dark:bg-gray-900 text-gray-900 dark:text-white border-2 border-b-white dark:border-b-gray-900 border-gray-200/60 dark:border-gray-800 translate-y-[2px]' : 'text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 hover:bg-white/50 dark:hover:bg-gray-800/50'
                            }`}
                        >
                        ...
                        <button 
                            ...
                            className={`w-full sm:w-auto px-5 py-3 rounded-t-2xl font-black text-sm tracking-wide transition-all ${
                                activeTab === 'billing' ? 'bg-white dark:bg-gray-900 text-gray-900 dark:text-white border-2 border-b-white dark:border-b-gray-900 border-gray-200/60 dark:border-gray-800 translate-y-[2px]' : 'text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 hover:bg-white/50 dark:hover:bg-gray-800/50'
                            }`}
                        >
