...
export default function SuperAdminUsers({
    ...
    const resetPassword = (user) => {
        ...
        router.post(route('superadmin.users.reset-password', user.id), {}, { preserveScroll: true });
    };
            ...
            {statusTarget && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
                    <div className="w-full max-w-md rounded-2xl bg-white dark:bg-gray-900 p-6 shadow-2xl">
                        <h3 className="text-lg font-black text-gray-900 dark:text-white">{statusTarget.raw_status === 'suspended' ? 'Activate User' : 'Suspend User'}</h3>
