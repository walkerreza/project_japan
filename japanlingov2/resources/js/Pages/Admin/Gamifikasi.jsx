                            ...
                            {achievements.map((ach) => (
                                <div key={ach.id} className="border border-gray-100 dark:border-gray-800 rounded-2xl p-4 bg-white dark:bg-gray-900 relative overflow-hidden group hover:border-gray-200 dark:border-gray-700 transition-all">
                                    ...
                                    <div className="flex flex-col gap-3 pl-4 sm:flex-row sm:items-center sm:gap-6 w-full">
                                        <div className="w-12 h-12 rounded-2xl bg-red-50 dark:bg-red-900/20 flex items-center justify-center text-2xl shrink-0 border border-red-100 dark:border-red-900/30">{ach.icon || '🏅'}</div>
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <div className="flex flex-wrap gap-2 mt-2">
                                                <span className="text-[10px] font-bold bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-400 px-2 py-0.5 rounded-full">{CONDITION_LABELS[ach.condition_type] || ach.condition_type}</span>
                                        ...
                                        <div className="flex items-center gap-1 shrink-0">
                                            <button onClick={() => handleEdit(ach)} className="p-2 text-gray-300 hover:text-blue-600 dark:text-blue-400 hover:bg-blue-50 dark:bg-blue-900/20 rounded-xl transition-colors"><EditIcon sx={{ fontSize: 18 }} /></button>
                                            <button onClick={() => handleDelete(ach.id)} className="p-2 text-gray-300 hover:text-red-600 dark:text-red-400 hover:bg-red-50 dark:bg-red-900/20 rounded-xl transition-colors"><DeleteIcon sx={{ fontSize: 18 }} /></button>
                                        </div>
                                    </div>
                                </div>
                            ))}
