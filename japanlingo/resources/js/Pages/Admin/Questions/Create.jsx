            ...
            <div className="min-h-screen bg-[#F8F9FB] font-sans">
                ...
                <header className="bg-white border-b border-gray-200 px-6 py-4 sticky top-0 z-40 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        <Link href={route('admin.questions.index')} className="w-8 h-8 rounded-lg bg-gray-50 flex items-center justify-center text-gray-400 hover:text-gray-900 transition-colors">
                        ...
                        <div>
                            <h1 className="text-sm font-black text-gray-900">Tambah Pertanyaan Baru</h1>
                            <p className="text-[11px] text-gray-400 font-medium">Isi detail pertanyaan dan jawaban</p>
                        </div>
                    </div>
                    <button
                ...
                <main className="max-w-3xl mx-auto p-6 space-y-5">
                    ...
                    <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 space-y-4">
                        <h2 className="text-sm font-black text-gray-700 uppercase tracking-wider">Informasi Pertanyaan</h2>

                        <div>
                            <label className="block text-sm font-bold text-gray-700 mb-1.5">Kuis <span className="text-red-500">*</span></label>
                            <select
                                value={data.quiz_id}
                        ...
                        <div>
                            <label className="block text-sm font-bold text-gray-700 mb-1.5">Teks Pertanyaan <span className="text-red-500">*</span></label>
                            <textarea
                                value={data.question_text}
                                onChange={e => setData('question_text', e.target.value)}
                                rows={3}
                                className="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#E64A19]/30 focus:border-[#E64A19] resize-none"
                    ...
                    {quizType === 'listening' && (
                        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 space-y-4">
                            <h2 className="text-sm font-black text-gray-700 uppercase tracking-wider">File Audio</h2>
                            <div>
                                <label className="block text-sm font-bold text-gray-700 mb-1.5">URL Audio</label>
                                <input
                                    type="url"
                    ...
                    {quizType === 'multiple_choice' && (
                        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 space-y-4">
                            <div className="flex items-center justify-between">
                                <h2 className="text-sm font-black text-gray-700 uppercase tracking-wider">Pilihan Jawaban</h2>
                                ...
                                {data.options.map((opt, idx) => (
                                    <div key={idx} className="flex items-center gap-3">
                                        ...
                                        <input
                                            ...
                                            className="flex-1 px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#E64A19]/30 focus:border-[#E64A19]"
                    ...
                    <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 space-y-4">
                        <h2 className="text-sm font-black text-gray-700 uppercase tracking-wider">Jawaban</h2>
                        <div>
                            <label className="block text-sm font-bold text-gray-700 mb-1.5">
                                Jawaban Benar <span className="text-red-500">*</span>
                                {quizType === 'multiple_choice' && (
                                    <span className="ml-2 text-[11px] font-medium text-gray-400">(Ketik teks pilihan yang benar persis)</span>
                                )}
                            </label>
                            <input
                                type="text"
                        ...
                        <div>
                            <label className="block text-sm font-bold text-gray-700 mb-1.5">Penjelasan (Opsional)</label>
                            <textarea
