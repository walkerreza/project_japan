...
export default function LessonArticle({
    ...
    return (
        <article className="overflow-hidden rounded-[2rem] border border-gray-100 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-900">
            <style>{`
                .jl-ppt-slide {
            ...
            `}</style>
            <header className="relative overflow-hidden border-b border-gray-100 bg-[#111827] px-6 py-10 text-white dark:border-gray-800 sm:px-10">
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,_rgba(230,74,25,0.45),_transparent_34%),linear-gradient(135deg,_rgba(255,255,255,0.08),_transparent)]" />
                <div className="relative">
                    <div className="mb-5 flex flex-wrap items-center gap-2">
                        <span className="rounded-full bg-white/10 px-3 py-1 text-[10px] font-black uppercase tracking-[0.22em] text-orange-100">
                    ...
                    <div className="mt-5 flex flex-wrap gap-3 text-sm font-bold text-orange-50/80">
            ...
            <section className="px-6 py-8 sm:px-10 sm:py-10">
                <div className="mb-6 flex items-center gap-3">
                    ...
                    <div>
                        <p className="text-[10px] font-black uppercase tracking-[0.22em] text-gray-400">Materi Pelajaran</p>
                        <h2 className="text-xl font-black text-gray-900 dark:text-white">Konten Utama</h2>
                    </div>
                </div>

                {lesson?.content ? (
                    <div
                        className="prose prose-gray max-w-none text-gray-700 prose-headings:font-black prose-headings:text-gray-950 prose-p:leading-8 prose-a:text-[#E64A19] prose-strong:text-gray-950 dark:prose-invert dark:text-gray-300 dark:prose-headings:text-white dark:prose-strong:text-white"
                        dangerouslySetInnerHTML={{ __html: lesson.content }}
                    />
                ) : (
                    <p className="rounded-2xl border border-dashed border-gray-200 bg-gray-50 p-6 text-sm font-bold italic text-gray-400 dark:border-gray-700 dark:bg-gray-950/50 dark:text-gray-500">
            ...
            {(fileUrl || lesson?.type === 'file') && (
                <section className="border-t border-gray-100 bg-gray-50 px-6 py-8 dark:border-gray-800 dark:bg-gray-950/40 sm:px-10">
                    <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <p className="text-[10px] font-black uppercase tracking-[0.22em] text-gray-400">Dokumen Pendukung</p>
                                <h3 className="font-black text-gray-900 dark:text-white">{documentLabel}</h3>
                            </div>
                        </div>
                        {fileUrl && (
                    ...
                    {fileUrl && isPdf ? (
                        <div className="rounded-2xl border border-blue-100 bg-white p-8 text-center shadow-sm dark:border-blue-900/40 dark:bg-gray-900">
                            <PictureAsPdfIcon className="text-blue-600 dark:text-blue-300" sx={{ fontSize: 56 }} />
                            <h4 className="mt-3 text-lg font-black text-gray-900 dark:text-white">PDF siap dibaca</h4>
                        ...
                        <div className="rounded-2xl border border-dashed border-gray-200 bg-white p-8 text-center dark:border-gray-700 dark:bg-gray-900">
                            {isPresentation ? <SlideshowIcon className="text-blue-500" sx={{ fontSize: 52 }} /> : <InsertDriveFileIcon className="text-blue-500" sx={{ fontSize: 52 }} />}
                            <h4 className="mt-3 text-lg font-black text-gray-900 dark:text-white">Preview inline tidak tersedia untuk format ini.</h4>
                        ...
                        <div className="rounded-2xl border border-dashed border-gray-200 bg-white p-8 text-center text-sm font-bold text-gray-400 dark:border-gray-700 dark:bg-gray-900">
