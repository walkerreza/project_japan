            ...
            <div className="min-h-screen bg-[#F8F9FB] font-sans">
                ...
                <header className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 px-6 py-4 sticky top-0 z-40 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-sm font-black text-gray-900 dark:text-white">Edit Pelajaran</h1>
                            <p className="text-[11px] text-gray-400 dark:text-gray-500 font-medium truncate max-w-xs">{lesson.title}</p>
                        </div>
                    </div>
                    <button
